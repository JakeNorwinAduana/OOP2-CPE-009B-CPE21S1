...
class MyWindow:
    def __init__(self, win):
        ...
        self.Lbl1 = Label(win, fg="Green", bg="Grey", text="Simple Calculator", font=("Times New Roman", 25))
        self.Lbl1.place(x=50, y=30)

        self.Lbl2 = Label(win, text="Number 1 : ", bg="Gray", font=("Times New Roman", 10))
        self.Lbl2.place(x=60, y=100)
        self.Entry1 = Entry(win, bd=3)
        self.Entry1.place(x=140, y=100)

        self.Lbl3 = Label(win, text="Number 2 : ", bg="Gray", font=("Times New Roman", 10))
        self.Lbl3.place(x=60, y=140)
        self.Entry2 = Entry(win, bd=3)
        self.Entry2.place(x=140, y=140)

        self.Lbl4 = Label(win, text="Answer : ", bg="Gray", font=("Times New Roman", 10))
